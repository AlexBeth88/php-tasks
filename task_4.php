            ...
            <div id="panel-1" class="panel">
                ...
                <div class="panel-container show">
                    <div class="panel-content">
                        <?php foreach ($progress_bars as $item) : ?>
                            <div class="d-flex">
                                <?php echo $item['title'] ?>
                                <span class="d-inline-block ml-auto"><?php echo $item['value'] ?></span>
                            </div>
                            <div class="progress progress-sm mb-3">
                                <div class="progress-bar <?php echo $item['bg'] ?>" role="progressbar" style="width: <?php echo $item['width'] ?>;" aria-valuenow="<?php echo $item['current_value'] ?>" aria-valuemin="<?php echo $item['min_value'] ?>" aria-valuemax="<?php echo $item['max_value'] ?>"></div>
                            </div>
                        <?php endforeach; ?>
