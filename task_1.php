...
<?php
$elements = ["reports file" => "Reports", "analytics graphs" => "Analytics", "export download" => "Export", "storage" => "Storage"];
?>
                                ...
                                <ul id="js-list-msg" class="list-group px-2 pb-2 js-list-filter">
                                    <?php foreach ($elements as $tag => $element) : ?>
                                        ...
                                        <li class="list-group-item">
                                            <span data-filter-tags="<?php echo $tag; ?>"><?php echo $element; ?></span>
                                        </li>
